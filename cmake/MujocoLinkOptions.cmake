...
function(get_mujoco_extra_link_options OUTPUT_VAR)
  if(MSVC)
    ...
    set(HAS_EXPLICIT_LINKER FALSE)
    set(CONFIGURED_LINKER_FLAGS
        "${CMAKE_EXE_LINKER_FLAGS} ${CMAKE_SHARED_LINKER_FLAGS} ${CMAKE_MODULE_LINKER_FLAGS}")
    if(CMAKE_LINKER OR CONFIGURED_LINKER_FLAGS MATCHES "(^|[ ;])-fuse-ld=")
      set(HAS_EXPLICIT_LINKER TRUE)
    endif()
